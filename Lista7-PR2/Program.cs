                ...
                switch (exec)
                {
                    case 1:
                        ...
                        while (true)
                        {
                            ...
                            Console.Write("quanto custa o produto que você deseja comprar?");
                    ...
                    case 5:
                        while (true)
                        {
                            Console.Write("digite um número de 1 a 12 (cada um corresponde a um mês do ano!): ");
                    ...
                    case 7:
                        ...
                        Console.Write("Digite um número (ele obrigatóriamente tem que ser positivo e inteiro!): ");
